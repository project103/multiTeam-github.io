...
<body>
    ...
    <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td>UserId:<?php echo $_SESSION["userId"] ?></td>
                                </tr>
                                <tr>
                                    <td>Name:<?php echo $_SESSION["userName"] ?></td>
                                </tr>
                                <tr>
                                    <td>Email:<?php echo $_SESSION["userEmail"] ?></td>
                                </tr>
                                <tr>
                                    <td>Prograss:<?php echo $_SESSION["userPrograss"] ?></td>
                                </tr>
                                <tr>
                                    <td>Role:<?php echo $_SESSION["userRole"] ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="col-lg-4 mt-5 mt-lg-0">
            <div class="mb-5">
                <h2 class="mb-4">purchased Courses</h2>
                <a class="d-flex align-items-center text-decoration-none mb-4" href="Course vedio.php">
                    ...
                    <div class="pl-3">
                        ...
                        <div class="d-flex">
                            ...
                            <small class=""><i class="fa fa-star text-primary mr-2"></i>4.5 (250)</small>
                        </div>
                    </div>
                </a>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-white-50 mb-2" href="course.php"><i
    ...
    <a href="#" class="btn btn-lg btn-primary rounded-0 btn-lg-square back-to-top"><i
            class="fa fa-angle-double-up"></i>backS</a>
